...
/**
 * The game requires to load saved values from a file, which are set in
 * the lists of generators. This exception is thrown when such values
 * are updated without permission by other methods.
 */
