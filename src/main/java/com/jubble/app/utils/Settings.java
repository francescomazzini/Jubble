...
public class Settings {
  ...
  private static List<Generator> generators =
      List.of(
          ...
          new Generator(new GeneratorID("Electron Absorber", ""), new GeneratorValues(60, 20, 1.15)),
          new Generator(new GeneratorID("Nucleus Extractor", ""), new GeneratorValues(720, 90, 1.14)),
          new Generator(new GeneratorID("Hydrogenator", ""), new GeneratorValues(8640, 360, 1.13)),
          new Generator(new GeneratorID("Dyson Sphere", ""), new GeneratorValues(103680, 2160, 1.12)),
          new Generator(new GeneratorID("Black Hole Reverser", ""), new GeneratorValues(1244160, 6480, 1.11)));
