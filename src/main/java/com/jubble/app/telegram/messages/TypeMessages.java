...
public class TypeMessages {
  ...
  /**
   * It contains the pairs of a String (which represents the CallBackAction that can activate the following message)
   *  and of a TelegramMessage (that represents the response of that CallBackAction called)
   */
