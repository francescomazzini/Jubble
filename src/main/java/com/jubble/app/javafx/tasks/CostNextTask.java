...
public class CostNextTask extends Task<Void>{
     ...
     * every 500ms it updates the progress (@updateProgress) of the generator cost
     *
     * @return nothing
     ...
     * generator cost. Not only does it update the progress itself
     * but also it gives a message that is binded to the label which represents the next cost generator
     *
